...
#ifndef XYO_WIN_DISCONTINUED_WEBBROWSER_HPP
#define XYO_WIN_DISCONTINUED_WEBBROWSER_HPP
...
namespace XYO::Win::Discontinued {
	...
	class WebBrowser : public virtual Window,
		...
		public:
			...
			// Browser
			inline void setBrowserDefaultAddress(const String &url) {
				browserDefaultAddress_ = url;
			};

			XYO_WIN_EXPORT int Navigate(String url);
	};
